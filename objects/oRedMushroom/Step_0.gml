...
//State Machine
	switch(state)
	{
		...
		shootTimer++;
		//create bullet
		if shootTimer == 1{ bulletInst = instance_create_depth(x+bulletXOff*face,y+bulletYOff,depth,oRedMushroomBullet);}
...
if hp<=0
{
	create_animated_vfx(x,y,depth,sDeadRedMushroomExp);
}
